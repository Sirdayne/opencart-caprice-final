<div class="row row-edit">
  ...
  <div class="col-sm-12">
    ...
    <!--<input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />-->
        <input type="text" name="city" value="Astana" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group required" style="display:none;">
    ...
    <!--<input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />-->
      ...
      <div class="form-group required" style="display:none;">
        <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
	  <input type="text" value="109" name="country_id" id="input-payment-country" class="form-control">
      </div>
      ...
      <div class="form-group required" style="display:none;">
        <label class="control-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
        <input type="text" value="1720" name="zone_id" id="input-payment-zone" class="form-control">
      </div>
...
<!-- M Y M Y M DELETE CHECKED IN LAST ROW -->
