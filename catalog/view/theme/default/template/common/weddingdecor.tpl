	...
	<!--<div class="wrapper white-wrapper">
			...
			<div class="content-holder">
				<div class="header-top header-top-fd">
					...
					<div class="block center">
						<span class="logo-block"><img src="catalog/view/theme/default/img/logo-pink.png" alt=""/></span>
					</div>
					<div class="block">
						<address class="adress adress-dark">
				...
				<nav class="nav-fd">
					<ul>
						...
						<li><a href="" class="dropdown-arrow active-menu">Услуги</a>
							<ul>
		...
		<div class="header-picture">
			<div class="header-picture-desc hpd-2">
				<h1>Украшение мероприятий</h1>
				<p>Украшение мероприятий - одна из важных составляющих в оформлении торжеств любого уровня. Яркие события жизни всегда ждут с особым трепетом, готовимся за долгое время до мероприятия. А наша фантазия и любовь к флористике помогают создавать оригинальные букеты на все случаи жизни.
					<br>Создайте неповторимое украшение торжества!
				</p>
			</div>
			<div class="pic-wrapper eventdecor-picture"></div>
		</div>
		...
		<!--<footer>
			<div class="footer-menu footer-menu-dark clearfix">
				<div><img src="catalog/view/theme/default/img/logo-kapriz-dark.png" alt="Логотип цветочного бутика Kapriz"></div>
				<div>
					<h6>Меню</h6>
					<ul>
						<li><a href="#">О компании</a></li>
