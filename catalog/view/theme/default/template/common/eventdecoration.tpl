	...
	<!--<a  class="consult-btn md-trigger block-1" data-modal="modal-1">консультация</a>-->	
		...
		<div class="header-picture">
            ...
            <div class="m-under-desc">
                <p>Украшение мероприятий - одна из важных составляющих в оформлении торжеств  любого уровня.</p>
                <p>Яркие события жизни всегда ждут с особым трепетом, готовимся за долгое время до мероприятия. А наша фантазия и любовь к флористике помогают создавать оригинальные букеты на все случаи жизни.</p>
                <p>Создайте неповторимое  украшение торжества!</p>
            </div>
		</div>
