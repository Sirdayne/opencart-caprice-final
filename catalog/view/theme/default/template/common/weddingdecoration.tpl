	...
	<!--<a  class="consult-btn md-trigger block-1" data-modal="modal-1">консультация</a>-->	
		...
		<div class="header-picture">
			<div class="header-picture-desc hpd-4">
				...
				<p>Свадебный декор - это не просто красивая комбинация из цветов, но и  неотъемлемая часть торжества, создание единого стиля и настроения.
					В этот прекрасный день мы подумаем за Вас о свадебном декоре в независимости от того, устраиваете Вы “пир на весь мир” или скромное семейное торжество.<br>
					Мы подскажем Вам:<br>
			...
			<div class="m-under-desc">
				<p>Свадебный декор - это не просто красивая комбинация из цветов, но и  неотъемлемая часть торжества, создание единого стиля и настроения.</p>
				<p>В этот прекрасный день мы подумаем за Вас о свадебном декоре в независимости от того, устраиваете Вы “пир на весь мир” или скромное семейное торжество.</p>
				<p>Мы подскажем Вам:</p>
				<ul>
					<li>в выборе свадебных букетов,</li>
					<li>в дополнении свадебного образа цветами,</li>
					<li>в украшении стола молодоженов,</li>
					<li>в оформлении столов для гостей на свадьбе,</li>
					<li>в оформлении арок, президиумов, подарочных букетов</li>
				</ul>
			</div>
		</div>
		<section class="artificial">
            <div class="middle-wrapper">
                ...
                <div class="box">
                    <svg width="100%" height="100%">
                        <line class="top" x1="0" y1="0" x2="1350" y2="0"></line>
                        <line class="left" x1="0" y1="280" x2="0" y2="-560"></line>
                        <line class="bottom" x1="450" y1="280" x2="-900" y2="280"></line>
                        <line class="right" x1="450" y1="0" x2="450" y2="840"></line>
                    </svg>
                </div>
				<div class="box box-tablet">
					<svg width="100%" height="100%">
						<line class="top" x1="0" y1="0" x2="975" y2="0"></line>
						<line class="left" x1="0" y1="180" x2="0" y2="-360"></line>
						<line class="bottom" x1="325" y1="180" x2="-650" y2="180"></line>
						<line class="right" x1="325" y1="0" x2="325" y2="540"></line>
					</svg>
				</div>
            </div>
			<div class="middle-wrapper clearfix">
				...
				<div class="box box-2 box-tablet">
					<svg width="100%" height="100%">
						<line class="top" x1="0" y1="0" x2="975" y2="0"></line>
						<line class="left" x1="0" y1="180" x2="0" y2="-360"></line>
						<line class="bottom" x1="325" y1="180" x2="-650" y2="180"></line>
			...
			<div class="middle-wrapper clearfix">
				<div class="flower-box flower-box-4">
				...
				<div class="box box-3 box-tablet">
					<svg width="100%" height="100%">
						<line class="top" x1="0" y1="0" x2="975" y2="0"></line>
						<line class="left" x1="0" y1="180" x2="0" y2="-360"></line>
						<line class="bottom" x1="325" y1="180" x2="-650" y2="180"></line>
		...
		<section class="howwework">
			<div class="pink-middle clearfix">
				...
				<div class="step-3 clearfix"><div class="step-icon-holder"></div><p>Мы предоставляем <br>заказ вовремя и в <br>лучшем виде</p></div>
				<div class="step-2 clearfix"><div class="step-icon-holder"></div><p>Мы подтверждаем заказ <br>и уточняем с Вами
					<br>детали свадебного <br>оформления</p></div>
				<div class="step-1 clearfix"><div class="step-icon-holder"></div><p>Вы оставляете <br>заявку на сайте</p></div>
			</div>
		</section>
		<section class="reasons">
            <div class="reasons-wrap">
                <div class="secrets">
                    <h3><span>Пять секретов</span> красивой вадьбы</h3>
                    <ul>
                        <li><span>Размах мероприятия</span><p>Наши возможности зависят от Ваших желаний.</p></li>
                        <li><span>Широкие возможности</span><p>Нам поставляют цветы со всего мира. Красивые букеты, цветочные композиции обеспечат улыбки и праздничное настроение гостей праздника.</p></li>
                        <li><span>Профессиональные флористы</span><p>Мы поможем оформить любой праздник -
                            от скромной свадебной церемонии до оформления загородных резиденций VIP-персон.</p></li>
                        <li><span>Креативность идей</span><p>Мы не применяем шаблонных решений в подготовке свадеб наших клиентов.</p></li>
                        <li><span>Совершенство стилистики</span><p>Утонченный стиль интерьера, элитные аксессуары создадут единый стиль свадебного декора и праздничное настроение.</p></li>
                    </ul>
                </div>
                <div class="big-bouquet">
                    <img src="catalog/view/theme/default/img/big-bouquet.png" alt="Букет с красивой свадьбы">
                </div>
            </div>
		</section>
        <section class="innumbers">
            <h3>Мы в цифрах</h3>
            <div class="numbers-wrap clearfix">
                <div class="number-box"><span>2000</span><span>довольных <br>клиентов</span><div class="num-1-icon"></div></div>
                <div class="number-box"><span>20 000</span><span>проданных <br>букетов</span><div class="num-2-icon"></div></div>
                <div class="number-box"><span>100</span><span>услуг по оформлению <br>мероприятий</span><div class="num-3-icon"></div></div>
                <div class="number-box"><span>7</span><span>лет на рынке услуг</span><div class="num-4-icon"></div></div>
            </div>
        </section>
